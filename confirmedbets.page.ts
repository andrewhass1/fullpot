...
@Component({
  selector: 'app-confirmedbets',
  templateUrl: './confirmedbets.page.html',
  styleUrls: ['./confirmedbets.page.scss'],
})
export class ConfirmedbetsPage implements OnInit {
  date: string;
  error: string;
  loading: any;
  amount:Int16Array;
  ...
  private prepareDataRequest(): Observable<object> {
    // Define the data URL
    const dataUrl1 = 'http://localhost/rest/confirmedapi.php?username=' + this.userEmail;
    // Prepare the request
